...
## Example
The main function in KMeansStability is stability_analysis. This function evaluates a set of five different stability metrics across a range of $K$-means clusterings.
